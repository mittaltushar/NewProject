...
import 'package:rama_puzle/TopicData.dart';
...
class QuizChapterNew extends StatefulWidget {
  String? post_Id;
  final int category_id;
  final String? sub_category_id;
  final String? sub_name;
  QuizChapterNew({super.key,required this.post_Id, required this.category_id, required this.sub_category_id, required this.sub_name});

  @override
  State<QuizChapterNew> createState() => QuizChapterNew2(category_id: category_id, sub_category_id: sub_category_id, sub_name: sub_name);
}

class QuizChapterNew2 extends State<QuizChapterNew> {
  late final int? category_id;
  late final String? sub_category_id;
  late final String? sub_name;

  QuizChapterNew2({Key? key, required this.category_id, required this.sub_category_id, required this.sub_name});
...
/*TextEditingController addCommentController = TextEditingController();
  ...
  //late TopicList commentData;
  late TopicList topicData;
  //ViewAllCommentsModel? getAllCommentsData;

  //List<Reply>? getData;
  //String? commentId;
  deAddictionCommentListApi(String category_id, String sub_category_id) async {
    //print("++++++++++++++++++++++++++++++++++$getData");
...
/* var headers = {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('http://www.ramapuzzle.com/api/v1/topicList'));
    request.fields.addAll({
      'category_id' : category_id, 'subcategory_id': sub_category_id
    });
   */
/* request.fields.addAll({
     *//*
...
/*
    ...
    if (response.statusCode == 200) {
      ...
      //jsonResponse =
      TopicList data = TopicList.fromJson(jsonDecode(finalResponse));
      setState(() {
        topicData= data;
        //getData;
...
/*'content': addCommentController.text,*//*
  ...
  void initState() {
    ...
    super.initState();
    deAddictionCommentListApi(category_id.toString(), sub_category_id.toString());
  }
