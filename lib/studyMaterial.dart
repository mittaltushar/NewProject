...
class StudyMaterial extends StatefulWidget {
  ...
  final String? reward;
  const StudyMaterial({Key? key, required this.topic_id,required this.category_id, required this.sub_category_id
    , required this.sub_name, required this.description, required this.reward
  }) : super(key: key);
  ...
  @override
  State<StudyMaterial> createState() => StudyMaterial1(topic_id: topic_id,category_id: category_id, sub_category_id: sub_category_id,
      sub_name: sub_name, description: description, reward: reward
  );
}

class StudyMaterial1 extends State<StudyMaterial> {
  final int topic_id ;
  final int category_id;
  final String? sub_category_id;
  final String? sub_name;
  ...
  final String? reward;
  int chapterCount =0  ;
  StudyMaterial1({Key? key, required this.topic_id,required this.category_id, required this.sub_category_id, required this.sub_name
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => startQuiz(topic_id: topic_id, sub_name: sub_name!,reward: reward!) /*StudyMaterialList(study_topic_id: 1,sub_category_id: "",sub_name: "",)*/));
                             /* =>
